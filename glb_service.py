...
async def glb(
    ...
    headers = {
        "Content-Disposition": 'attachment; filename="case.glb"',
        "X-Glb-Size": str(len(glb_bytes)),          # exakte Byte-Zahl fuer Shopify
        "Access-Control-Expose-Headers": "X-Glb-Size, X-Case-Warning",
    }
    if warning:
